...
```bash
sudo python3 pygettext.py -a -v -d messages -o i18n/ospy_messages.pot ospy/*.py ospy/templates/*.html plugins/*.py plugins/*/*.py plugins/*/templates/*.html setup.py back_door.py api/*.py api/v1/*.py web/session.py
```
