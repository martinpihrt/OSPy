 ...
 * Martin Pihrt - 10.09.2021
 * Arduino IDE >= 1.8.15, Select board: doit ESP32 devkit V1
 ...
 *  Manual switch relay to on/off with AP button (if press time <4 seconds)
 *  
...
// FW version
int fw_version = 117;        // ex: FW version 117 is 1.17
/* 
...
void setup() {
  ...
  // ADS1115 begin
  #ifdef DEBUG
     Serial.print("ADS1X15 LIB VERSION: ");
     Serial.println(ADS1X15_LIB_VERSION);
  #endif 
  if(!ADS1.begin()) {
    #ifdef DEBUG
        Serial.println("Failed to initialize ADS1115 on 0x48."); Serial.flush();
    #endif
    ...
    #ifdef DEBUG
        Serial.println("Initialize ADS1115 on 0x48 OK."); Serial.flush();
    #endif    
  }
  
  if(!ADS2.begin()) {
    #ifdef DEBUG
        Serial.println("Failed to initialize ADS1115 on 0x49."); Serial.flush();
    #endif
    ads2_err = true;    
  }
  else{
    ...
    ADS2.setGain(0);   
    #ifdef DEBUG
        Serial.println("Initialize ADS1115 on 0x49 OK."); Serial.flush();
    #endif    
  }
    
  if(!ADS3.begin()) {
    #ifdef DEBUG
        Serial.println("Failed to initialize ADS1115 on 0x4A."); Serial.flush();
    #endif
    ads3_err = true;
  }
  else{
    ...
    ADS3.setGain(0);   
    #ifdef DEBUG
        Serial.println("Initialize ADS1115 on 0x4A OK."); Serial.flush();
    #endif    
  }
    
  if(!ADS4.begin()) {
    #ifdef DEBUG
        Serial.println("Failed to initialize ADS1115 on 0x4B."); Serial.flush();
    #endif
    ads4_err = true;
  }
  else{
    ...
    ADS4.setGain(0);   
    #ifdef DEBUG
        Serial.println("Initialize ADS1115 on 0x4B OK."); Serial.flush();
    #endif    
  }     
