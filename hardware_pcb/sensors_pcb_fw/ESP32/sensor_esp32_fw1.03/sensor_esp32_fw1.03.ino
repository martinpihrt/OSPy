 ...
 *  Todo moisture sensor, leak detector sensor, ultrasonic...  
*/
...
// FW version
int fw_version = 103;        // ex: FW version 103 is 1.03 
/* 
...
void setEEPROMdefault(){ 
   ...
   setEEPROMString(offsetof(eepromdata_t, INVERT_DRY), elementSize(eepromdata_t, INVERT_DRY), "0");
