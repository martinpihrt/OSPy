...
Erst wenn alle Schlüssel und Prüfsummen in einem einzigen schreibgeschützten Abbild übereinstimmen, führt OSPy eine probeweise Dekodierung durch und wendet die normale Einstellungsvalidierung auf die rekonstruierten SQLite-Werte an. Das rekonstruierte Wörterbuch wird verworfen und niemals der laufenden Konfiguration zugewiesen. Die Diagnose meldet, ob dieser SQLite-Lesetest bestanden wurde; ein Fehler bleibt eine Warnung und der Start wird ausschließlich mit den bereits geladenen shelve-Einstellungen fortgesetzt.
