...
Das optionale Plug-in **Automation Rules** erstellt grafische AND/OR-Regeln aus zwischengespeicherten Werten von Überwachungs-Plug-ins, aktivierten Pihrt- oder Shelly-OSPy-Sensoren, lokalem Datum und Uhrzeit sowie schreibgeschützten OSPy-Systemzuständen. Eine Regel kann auf dauerhaft erfüllte Bedingungen warten, Warnungen wiederholen und die Rückkehr zum Normalzustand über Home, Browser, E-Mail, Telegram oder mobilen Push melden. Ein separater, standardmäßig deaktivierter Steuerschalter erlaubt geschützte einmalige Aktionen: ausgewählte Stationen, alle Ausgänge oder laufende Programme stoppen, den Planer deaktivieren, einen bestimmten Ausgang im manuellen Modus für eine zwingend begrenzte Dauer einschalten, die globale Wasserstufe ändern oder eine von einem anderen Anbieter ausdrücklich deklarierte Aktion aufrufen. Der Testmodus simuliert Aktionen nur und protokolliert die Ergebnisse. Eine optionale Vorfallsperre erfordert die Bestätigung durch einen Administrator, nachdem alle Bedingungen verfügbar und inaktiv sind; das Entsperren macht ausgeführte Aktionen niemals rückgängig.
