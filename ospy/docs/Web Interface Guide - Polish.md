...
Opcjonalna wtyczka **Automation Rules** tworzy graficzne reguły AND/OR z buforowanych wartości wtyczek monitorujących, włączonych czujników OSPy Pihrt lub Shelly, lokalnej daty i czasu oraz stanów systemu OSPy przeznaczonych tylko do odczytu. Reguła może czekać na trwałe spełnienie warunków, powtarzać alarm i zgłaszać powrót do normy przez Home, przeglądarkę, e-mail, Telegram lub mobilne push. Oddzielny, domyślnie wyłączony przełącznik sterowania umożliwia chronione jednorazowe działania: zatrzymanie wybranych stacji, wszystkich wyjść lub działających programów, wyłączenie harmonogramu, włączenie konkretnego wyjścia w trybie ręcznym na obowiązkowo ograniczony czas, zmianę globalnego poziomu wody albo wywołanie działania jawnie zadeklarowanego przez innego dostawcę. Tryb testowy jedynie symuluje działania i zapisuje wyniki. Opcjonalna blokada incydentu wymaga potwierdzenia administratora po udostępnieniu i dezaktywacji wszystkich warunków; odblokowanie nigdy nie cofa wykonanego działania.
